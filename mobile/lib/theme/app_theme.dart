...
class AppTheme {
  ...
  static ThemeData get light => ThemeData(
        ...
        appBarTheme: AppBarTheme(
          ...
          titleTextStyle: AppTextStyles.bodySMStrong.copyWith(color: AppColors.ink),
        ),
        inputDecorationTheme: InputDecorationTheme(
          ...
          labelStyle: AppTextStyles.bodySM.copyWith(color: AppColors.mute),
          hintStyle: AppTextStyles.bodyMD.copyWith(color: AppColors.muteSoft),
        ),
  ...
  static ThemeData get dark => ThemeData(
        ...
        appBarTheme: AppBarTheme(
          ...
          elevation: 0,
          scrolledUnderElevation: 0,
          titleTextStyle: AppTextStyles.bodySMStrong.copyWith(color: AppColors.darkInk),
        ),
        inputDecorationTheme: InputDecorationTheme(
          filled: true,
          ...
          labelStyle: AppTextStyles.bodySM.copyWith(color: AppColors.darkMute),
          hintStyle: AppTextStyles.bodyMD.copyWith(color: AppColors.darkMuteSoft),
        ),
        cardTheme: CardThemeData(
